...
public class DocumentResourceIntTest {
    ...
    private static final String DEFAULT_DOCUMENT_FILE = "AAAAAAAAAA";
    private static final String UPDATED_DOCUMENT_FILE = "BBBBBBBBBB";
    ...
    public void setup() {
        ...
        DocumentResource documentResource = new DocumentResource(documentRepository, documentSearchRepository);
    ...
    public void createDocument() throws Exception {
        ...
        assertThat(testDocument.getDocumentFile()).isEqualTo(DEFAULT_DOCUMENT_FILE);
    ...
    public void getAllDocuments() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].documentFile").value(hasItem(DEFAULT_DOCUMENT_FILE.toString())));
    }
    ...
    public void getDocument() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents/{id}", document.getId()))
            ...
            .andExpect(jsonPath("$.documentFile").value(DEFAULT_DOCUMENT_FILE.toString()));
    }
    ...
    public void updateDocument() throws Exception {
        ...
        Document testDocument = documentList.get(documentList.size() - 1);
        assertThat(testDocument.getDocumentFile()).isEqualTo(UPDATED_DOCUMENT_FILE);
